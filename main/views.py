...
def generate_report(document):
    ...
    p.drawString(100, 730, f"Date : {document.upload_date.strftime('%d/%m/%Y')}")
    ...
    details = [
        ...
        ("Émissions de carbone", document.carbon_emissions),
        ("Gestion de l'eau", document.water_management),
        ("Qualité de l'air intérieur", document.indoor_air_quality),
    ]

    for label, value in details:
        p.drawString(100, y, f"{label} : {value if value is not None else 'N/A'}")
        y -= 20
