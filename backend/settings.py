...
MIDDLEWARE = [
    ...
    'main.middleware.RedirectWwwMiddleware',   # www → sans www
...
DEFAULT_FROM_EMAIL  = EMAIL_HOST_USER or 'noreply@conformexpert.cc'
CONTACT_EMAIL       = os.environ.get('CONTACT_EMAIL', 'contact@conformexpert.cc')
